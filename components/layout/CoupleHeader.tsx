...
import { User, LogOut, PanelLeft, PanelLeftClose, ChevronDown } from 'lucide-react'
        ...
        <div className="relative z-[103]">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2.5 px-2 py-1.5 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
            ...
            <DropdownMenuContent align="end" className="w-52 p-1">
              ...
              <DropdownMenuItem
                ...
                className="flex items-center gap-2.5 cursor-pointer text-red-600 focus:text-red-600 rounded-md px-2.5 py-2"
              >
