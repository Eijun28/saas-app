...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  // We use openProp and setOpenProp if it's provided, otherwise we use internal state.
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "peer-data-[variant=inset]:min-w-[calc(100svw-var(--sidebar-width))]",
          className
        )}
        {...props}
      />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn("bg-sidebar-border mx-2 h-px w-[calc(100%-1rem)]", className)}
      {...props}
    />
  )
})
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          "flex min-h-0 flex-1 flex-col gap-2 overflow-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden group-data-[collapsible=icon]:overflow-y-auto",
          className
        )}
        {...props}
      />
