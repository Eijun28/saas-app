            ...
            {nextActions.length === 1 ? (
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                ...
                <button
                  ...
                  className="flex-shrink-0 inline-flex items-center justify-center gap-1.5 px-4 py-2 text-[13px] font-semibold text-white bg-[#823F91] hover:bg-[#5C2B66] rounded-xl transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#823F91]/40 w-full sm:w-auto"
                >
                ...
                <div className="space-y-2">
                  {nextActions.slice(0, 3).map((action, idx) => (
                    <div key={idx} className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                      <p className="flex-1 text-sm font-semibold text-gray-800 leading-snug min-w-0">{action.text}</p>
                      <button
                        onClick={() => router.push(action.href)}
                        className="flex-shrink-0 inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-[12px] font-semibold text-white bg-[#823F91] hover:bg-[#5C2B66] rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#823F91]/40 w-full sm:w-auto"
                      >
