...
export default function PricingSection() {
  ...
  const prestatairesPricingBase: Array<Omit<PricingColumnProps, 'price' | 'billingPeriod'> & { monthlyPrice: number; comingSoon?: boolean }> = [
    {
      name: "DÉCOUVERTE",
      description: "Pour tester NUPLY gratuitement",
      monthlyPrice: 0,
      priceNote: "",
      cta: {
        variant: "outline",
        label: user ? "Activer Découverte" : "S'inscrire gratuitement",
        href: "/sign-up?plan=discovery",
      },
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        "Templates devis illimités + génération PDF",
        "Factures (conversion devis→facture, calcul TVA)",
        "Calendrier/Agenda (vue semaine/mois)",
        "Analytics (impressions, clics, CTR)",
        "Toutes cultures, tous types d'événements",
        "Badge \"Pro\"",
        "Code parrainage actif",
      ],
      variant: "default",
      comingSoon: true,
    },
    {
      ...
      cta: {
        variant: "default",
        label: user ? "Activer Expert" : "S'inscrire et activer Expert",
        href: user ? undefined : "/sign-up?plan=expert",
        planType: "expert",
        onClick: user ? undefined : () => router.push("/sign-up?plan=expert"),
      },
      features: [
        "Tout du pack Pro",
        "Multi-comptes (jusqu'à 3 collaborateurs)",
        "Portfolio illimité",
        "Factures personnalisées (logo, en-tête, IBAN, préfixes)",
        "Devis avec rappels auto avant expiration",
        "Analytics avancés (historique, export data)",
        "Support prioritaire",
        "Badge \"Expert\"",
      ],
      variant: "default",
