            ...
            >
              ...
              <motion.div variants={itemVariants} className="pt-1">
                <motion.button
                  ...
                  className="group relative w-full h-12 sm:h-12 min-h-[44px] rounded-xl bg-[#823F91] hover:bg-[#6D3478] font-semibold text-white shadow-lg shadow-[#823F91]/25 hover:shadow-xl hover:shadow-[#823F91]/30 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#823F91]/25 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                >
